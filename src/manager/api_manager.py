...
class ApiManager(FastAPI):
    ...
    def __init__(self, bridge_manager: BridgeManager, filename: str, host: str | None = None, port: int = 8081, allow_origins: list[str] | str = '*', allow_credentials: bool = True, allow_methods: list[str] = ["*"], allow_headers: list[str] = ["*"]) -> None:
